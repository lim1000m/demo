...
function mapCommon(){
	...
	*******************************************************/
	...
	var _mapBaseProjection = new Proj4js.Proj("EPSG:900913");
	...
	this.setMapLayer = function () {
		_mapLayer1 = new OpenLayers.Layer.Google("Google Streets",{
			MIN_ZOOM_LEVEL: 9,
			MAX_ZOOM_LEVEL : 19
		});
		_mapLayer2 = new OpenLayers.Layer.Google("Google Satellite",{
